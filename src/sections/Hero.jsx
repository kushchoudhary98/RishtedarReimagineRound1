...
export default function Hero() {
    ...
    const heroBGOpacityMob = useTransform(scrollYProgress, [0.001, 0.1], [0.25, 0]);
    ...
    const heroPicYMob = useTransform(scrollYProgress, [0.1, 0.3], ["0%", "47%"]);
        ...
        <div className='w-screen'>
            <div ref={ref} className='h-[250vh] w-screen md:w-full top-0'>
                <div className='sticky flex flex-col justify-center items-center w-full h-[87vh] md:flex-row-reverse md:top-[13vh] top-[10vh]'>
                    <motion.div className='md:flex hidden justify-center items-center w-full h-full overflow-hidden'>
                        <motion.div
                            animate={{ scale: [1.2, 1.25, 1.25, 1], opacity: [0, 1, 1, 1] }}
                            ...
                            style={{ rotate: heroPicRotate, scale: heroPicScale, x: heroPicX, y: heroPicY, opacity: heroPicOpacity }} className='absolute z-30 w-full h-full'>
                        ...
                        <motion.div style={{ opacity: heroBGOpacity }} className='flex justify-center items-center w-full h-full'>
                            ...
                            <motion.div
                                ...
                                style={{ scale: heroBGScale }} className='relative flex flex-col justify-center -translate-y-[20%]'>
                                <p className='absolute -top-4 left-1 font-fredoka leading-tight font-medium text-[#4FC0D9] text-[23px]'>GET SET GROW</p>
                                <motion.p className='relative flex flex-row font-fredoka leading-tight font-medium text-[79px]'>
                    ...
                    <div className='relative flex md:hidden justify-center items-center w-screen md:w-[50vw] h-[50vh] md:h-[87vh]'>
                        <motion.div className='absolute overflow-hidden md:w-full w-screen h-full' style={{ opacity: heroPicOpacity, x: isMobile ? heroPicXMob : heroPicX, y: isMobile ? heroPicYMob : heroPicY, scale: isMobile ? heroPicScaleMob : heroPicScale }}>
                            <motion.div className='relative w-full h-full' style={{ rotate: heroPicRotate }}>
                                <motion.img
                                    ...
                                    src={heroPic} className='z-10 absolute rounded-full object-contain w-[320px] md:w-[70vh] left-1/2 top-1/2 -translate-y-[54%] -translate-x-[62%] -rotate-45 drop-shadow-hero' />
                            </motion.div>
                        </motion.div>
                        <motion.img
                            initial={{ opacity: 0 }}
                            ...
                            style={{ scale: heroBGScale, opacity: heroBGOpacityMob, rotate: heroBGRotate, mixBlendMode: "multiply" }}
                    ...
                    <motion.div
                        ...
                        className='relative flex md:hidden justify-start items-center md:w-[50vw] md:h-[87vh]'>
                        <HeroText />
                    </motion.div>
